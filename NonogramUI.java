...
public class NonogramUI {
    ...
    public String display(boolean showFullOnly) {
        ...
        int      numRows      = puzzle.getNumRows();//getting row number
    ...
    public void menu() {
        ...
        while (!command.equalsIgnoreCase("Q") && !puzzle.isSolved())  {
            displayMenu();
            command = getCommand();
            execute(command);
    ...
    private void displayMenu()  {
        ...
        System.out.println("   Load from file     [L]");
        System.out.println("   To end program     [Q]");    
    }
